...
- [x] Implement and locally test scoring, feedback, history and completion in the protected service. Hosted deployment and approved quiz content remain outstanding. The static preview enforces complete answers only and makes no certification or driving-test claims.
