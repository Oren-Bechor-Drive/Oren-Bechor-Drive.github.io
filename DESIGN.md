...
After each key point, reserve a compact, pale 80px-minimum-height video space with a dashed border and descriptive Hebrew text. These are accessible labeled placeholders, not broken images or inactive video players. Quiz sections end with a blue "לשאלון התרגול" link and a note identifying the 20 placeholder questions; reading-only sections omit this block. All course preview pages remain noindex.
