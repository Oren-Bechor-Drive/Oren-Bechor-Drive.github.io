...
Use media only where it helps explain the subject. Reserve video for movement, timing and developing hazards; use images or diagrams for recognition and road layouts. Summaries and administrative explanations need no media. Planned media uses a compact, 80px-minimum-height space with a solid surface-container-low background (#ecf0fa), a dashed border and descriptive Hebrew text. Do not use gradients in media placeholders. Video and image/diagram placeholders share this treatment and have explicit accessible labels, without broken images or inactive players. Complete right-turn and U-turn demonstrations absorb individual checks and completion steps. Quiz sections end with a blue "לשאלון התרגול" link and a note identifying the 20 placeholder questions; reading-only sections omit this block. All course preview pages remain noindex.
